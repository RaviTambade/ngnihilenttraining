...
export class FlowerService {
    ...
    private flowers: Flower[] = [
        ...
        { id: 4, title: 'Orchid', unitprice: 40,canSell:false },
        { id: 5, title: 'Lily', unitprice: 12,canSell:false },
        { id: 6, title: 'Tulip', unitprice: 30,canSell:false },
        { id: 7, title: 'Lotus', unitprice: 25,canSell:true },
      ];
